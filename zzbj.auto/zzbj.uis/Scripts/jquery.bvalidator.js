...
(function ($) {
    ...
    bValidator = function (mainElement, overrideOptions) {
        ...
        var options = {
            ...
            offset: { x: -5, y: -3 }, // offset position for error message tooltip
            ...
            lang: 'cn', 				// default language for error messages 
            ...
            errorMessages: {
                ...
                cn: {
                    ...
                    'equalto': '请确认两次输入的值相同！',
                    'differs': '请输入不相同的值！',
                    'minlength': '请输入正确的值，最小为{0}字符！',
                    'maxlength': '请输入正确的值，最多为{0}字符！',
                    'rangelength': 'The length must be between {0} and {1}',
                    'min': 'Please enter a number greater than or equal to {0}.',
                    'max': 'Please enter a number less than or equal to {0}.',
                    'between': 'Please enter a number between {0} and {1}.',
                    'required': '该字段为必填字段！',
                    'alpha': '请输入正确的字符(该字段只接受字母)！',
                    'alphanum': '请输入正确的字符(该字段只接受数字及字母)！',
                    'digit': 'Please enter only digits.',
                    'number': '请输入有效的数字！',
                    'email': '请输入正确的Email！',
                    'image': 'This field should only contain image types',
		...
		validator = {
		    ...
		    phone: function (v) {
		        var r = /^(\d{3,4})-(\d{7,8})/;
		        if (!r.test(v.value)&&!options.regex.phone.test(v.value))
		            return false
		        return true;
		       // return this.regex(v, options.regex.phone);
		    },
		    alphanum: function (v) {
